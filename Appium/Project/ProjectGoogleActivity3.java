...
public class ProjectGoogleActivity3 {
    // Driver Declaration
    ...
    @Test
    	...
    	// Enter text to add Google Keep Note
    	 ...
    	 wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//android.widget.Button[@content-desc=\"Reminder\"]")));
         driver.findElement(AppiumBy.accessibilityId("Reminder")).click();
         
         wait.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//android.support.v7.widget.RecyclerView[@resource-id='com.google.android.keep:id/bs_list_view']/android.widget.LinearLayout[1]")));
